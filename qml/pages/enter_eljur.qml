...
Page {
    ...
    property var placeholder: ["Юрл, https://lyceum-fa.eljur.ru", "Логин", "Пароль", "Ключ разработчика", "Вендор"]
    ...
    Rectangle {
        ...
        Column {
            ...
            Item {
                ...
                Text {
                    id: errorLabel2
                    text: "Неправильно введены данные или нет доступа"
                    color: "red"
                    font.pixelSize: 30
                    anchors.horizontalCenter: parent.horizontalCenter
                    anchors.bottom: button.top
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        if (allFilled) {
                            ...
                            enterInf.get_inf_eljur(fieldTexts);
                        } else {
